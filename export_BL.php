                    ...
                    <td>
                        ...
                        <th></th>
                            ...
                            <tr >
                                ...
                                <td style="padding-top:20px;height:30px;width:20%;background-color:#E5E5E5;padding-left:10px;" >
                                </td>
                            </tr>
                        </table>
                    </td>
...
$commande_num = trim($num_commande);
    ...
    $html2pdf->Output(__DIR__ .' /upload/'.$commande_num.'_BL.pdf', 'F');
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800 message" id="message">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 offset-lg-3">
                                        ...
                                        <a style="text-decoration:none;" href="mail_facture.php?num_commande=<?php echo $num_commande; ?>"><button style="margin-top:30px;" class="btn btn-success btn-lg btn-block" type="button" >oui</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
