                        ...
                        <table style="width:100%;margin-left:5px;cellspacing:0; cellpadding:0;border-spacing: 0; border-width: 0; padding: 0; border-width: 0;  border-collapse: collapse;">
                            <tr padding-top:20px;style="border-style:solid;border-width:1px;border-color:#DCDAD9;background-color:#E5E5E5;height:40px;">
                                ...
                                for($i=1;$i<=$_GET['taille'];$i++){
                                    ...
                                    $index_produit = "produit".$i;
                                    

                                    $valeur = (int)$_GET[$index_qte]*(int)$_GET[$index_prix];
                                ...
                                for($i=1;$i<=$_GET['taille'];$i++){
                                 ...
                                 $content.='
                            <tr >
                                <td  style="height:20px;width:30%;padding-top:10px;border-style:solid;border-width:1px;border-color:#DCDAD9;margin-right:-10px;padding-right:0px;text-align:right;padding-right:20px;">'.$_GET[$index_produit].'</td>
                                <td  style="height:20px;width:30%;padding-top:10px;border-style:solid;border-width:1px;border-color:#DCDAD9;padding-left:50px;text-align:right;padding-right:20px;">'.$_GET[$index_qte].'</td>
                                <td  style="height:20px;width:30%;padding-top:10px;border-style:solid;border-width:1px;border-color:#DCDAD9;text-align:right;padding-right:20px;">'.$_GET[$index_prix].'</td>
                                <td  style="height:20px;width:10%;padding-top:10px;border-style:solid;border-width:1px;border-color:#DCDAD9;text-align:right;padding-right:20px;">'.$multiplication[$j].'</td>
                            </tr>';
                                }
