                            ...
                            <div class="h6 mb-0 font-weight-bold text-gray-800 message" id="message">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control distributeur" id="distributeur" />
                                        <br />
                                ...
                                <button type="submit" id="bouton_distributeur2" class="btn btn-success btn-lg btn-block">Valider</button>
                                <br />
