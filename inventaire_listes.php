            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="utilities-color.html">Dépôt vente</a>
                ...
                <div class="container-fluid" style="max-width:700px;margin-bottom:30px;height:400px;">
                    ...
                    <form action="" method="POST">
                        <center>
                            ...
                            <h2 class="h4 mb-4 text-gray-800">Choisissez une catégorie :</h2>
                        </center>
                        <div class="row">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h6 mb-0 font-weight-bold text-gray-800">
                                                    ...
                                                    <select class="form-control" id="select-state" placeholder="AEMA" name="categorie">
                                                    ...
                                                    <?php
                                                        $req_volume = $bdd->prepare("SELECT * FROM volumes");
                                                    ...
                                                    if (isset($_POST['categorie'])) {
                                                        if (!empty($_POST['categorie']) and $_POST['categorie'] != "") {
                                                                        ...
                                                                        if (!empty($_POST['parfum']) and $_POST['parfum'] != "") {
                                                                            if (isset($_POST['quantite'])) {
                                                                                if (!empty($_POST['quantite']) and $_POST['quantite'] != "") {
                                                                                    ...
                                                                                    $req_insertion->execute(array(':categorie' =>$_POST['categorie'],
                                                                                                                ':volume' =>$_POST['volume'],
                                                                                                                ':parfum' =>$_POST['parfum'],
                                                            ...
                                                            window.location.href = 'inventaire_listes.php';
                                                            </script>
                                                            <?php
                                                        }
                                                    }
