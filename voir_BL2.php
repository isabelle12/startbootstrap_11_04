...
<div class="container fluid" style="color:black;height:;padding-top:30px;background-color:white;width:650px;">
    <div id="bordure" style="height:800px;border: 1px solid #E5E5E5;padding-top:20px;padding-left:20px;">
        <div class="row" >
            <div class="col-lg-5">
        ...
        <table width="90%" style="margin-left:10px;margin-right:10px;" >
            ...
            for($i=0;$i<count($req_commande2);$i++){
                ?>
                <tr>
                    <td style="width:50%;padding-top:10px;padding-left:10px;font-size:11px;border: 1px solid #E5E5E5;height:17px;padding-right:10px;height:50px;"><h6 style="font-size:13px;"><?php echo $req_commande2[$i]['produit'];?></h6></td>
                    <td style="width:50%;padding-top:10px;padding-left:10px;border: 1px solid #E5E5E5;text-align:right;padding-right:10px;height:50px;"><h6 style="font-size:13px;"><?php echo $req_commande2[$i]['qte'];?></h6></td>
    ...
    <?php
    $chaine_vers = "export_BL_3.php?details=".$_GET['details']."&nom=".$_GET['nom']."&enseigne=".$_GET['enseigne']."&adresse=".$_GET['adresse']."&mail=".$_GET['mail']."&telephone=".$_GET['telephone']."&num_commande=".$tableau_commande."&alerte=".$date_convertie2."&taille=".count($req_commande2)."&date_commande=".$date_convertie;
    //$chaine_vers = "trt10.php?details=".$_GET['details']."&nom=".$_GET['nom']."&enseigne=".$_GET['enseigne']."&adresse=".$_GET['adresse']."&mail=".$_GET['mail']."&telephone=".$_GET['telephone']."&num_commande=".$tableau_commande."&alerte=".$date_convertie2."&taille=".count($req_commande2)."&date_commande=".$date_convertie;
    ...
    ?>
    <a style="margin-left:30px;" id='lien_marche_pas' href="<?php echo $chaine_vers;?>"><button style='margin-top:30px;' type='button' class='btn btn-success btn-lg'>Signer</button></a><br/><br/><br/>
    <?php
