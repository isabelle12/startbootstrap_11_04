<?php
    ...
    ?><ul>
            <li style=" color: black; font-size: small; font-weight: bold;list-style-type: none; margin-left: -13% ">
                <a id="btn<?php echo $i; ?>" adresse="<?php echo $y['adresse']; ?>" telephone="<?php echo $y['telephone']; ?>" nom="<?php echo $y['nom']; ?>" mail="<?php echo $y['mail']; ?>" class="lien" href="creation_BC_BL3.php"><?= $y['nom'] ?><br> <?= $y['adresse'] ?> - <?= $y['telephone'] ?></a>
            </li>
        </ul>
        <?php
        $i+=1;
