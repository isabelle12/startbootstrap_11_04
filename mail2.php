...
try {
    ...
    $mail->addAttachment('upload/'.$num_facture.'_facture.pdf');         // Pièces jointes en gardant le nom du serveur



    //Content
    $mail->isHTML(true);                                  //Set email format to HTML
    $mail->Subject = ' numéro '.$num_facture;
        ...
        <ul class="navbar-nav bg-gradient-mauve sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="creation_BC_BL.php">Dépôt vente</a>
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800 message" id="message">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg- offset-lg-1">
                                        <br /><br />
                                        <div id="sig"></div>
                                        La facture a bien été envoyée par mail au client    
                                    </div>
                                </div>
                            </div>
                        </div>
