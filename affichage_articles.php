            ...
            <div id="content">
                ...
                <form action="" method="POST">
                    <table id="lastMateriel" class="table table-bordered " style="background-color:white;">
                        <tbody>
                            <tr>
                                <th>Disponibilité</th><th>Catégorie</th><th>Contenance</th><th>Parfum</th>
                            </tr>
                            <tr>
                                <td style="width:400px;">
                                    <select style="width:400px;" class="form-control categorie" name="parfum">
                                    <option value="">----</option>
                                ...
                                <td>
                                    <select class="form-control volume" id="select_volume" name="categorie">
                                        <option value="">----</option>
                                ...
                                <td>
                                    <select class="form-control clients" id="clients" name="parfum" >
                                        <option value="">----</option>

                                        <?php 
                                        $req_client = $bdd->prepare("SELECT * FROM clients");
                                        $req_client->execute(array());
                                        $req_client = $req_client->fetchAll();                
                                        foreach ($req_client as $result) {
                                        ?>
                                            <option value="<?php echo $result['id']; ?>"><?php echo $result['nom'];  ?></option>
                                        <?php
                                        }
                    ...
                    <center><button style="width:200px;" type="submit" class="btn btn-success btn-lg ">Valider</button></center>
