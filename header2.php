            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="caisse2.php?prix=vente">Caisse</a>
                    ...
                    <form
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" placeholder="Search for..."
                                aria-label="Search" aria-describedby="basic-addon2" id="search-stock8">
                        ...
                        <div id="position" style="position:relative">
                                    ...
                                    <div style="box-shadow: 15px 15px 15px #EBECEF; border-radius: 10px; margin-left: 0%;margin-top: 5%;position: absolute; top:0px;background-color: white;z-index: 15 ;">
