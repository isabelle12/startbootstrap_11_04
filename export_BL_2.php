...
try{
    ...
    $req_commande2 = $bdd->prepare("SELECT produit,qte,date_commande,date_alerte FROM commandes WHERE numero_commande='".$tableau_commande."'");
    $req_commande2->execute(array());
    $req_commande2 = $req_commande2->fetchAll();
    var_dump($req_commande2);
    /*while($req_commande2 = $req_commande2->fetch()){
        echo $req_commande2['produit'];
    }*/
    $content = '<page>
                    ...
                    <td>
                        <table style="width:100%;  cellspacing:0; cellpadding:0;margin-top:100px;">
                            <tr>
                                ...
                                <td style=" width:40%">
                                Date de la commande : '.$req_commande2[0]['date_commande'].'<br/>
                                Numéro de commande : '.$tableau_commande.'<br/>
                                Date alerte : '.$req_commande2[0]['date_alerte'].'<br/></td>
...
':num_commande' =>$num_commande,));    */
    ...
    $num_commande = $chaine_commande[0];
    //echo $num_commande;
    $html2pdf->Output(__DIR__ .' /upload/'.$num_commande.'_BL.pdf', 'F');
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800 message" id="message">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 offset-lg-3">
                                        ...
                                        <a style="text-decoration:none;" href="mail4.php?num_commande=<?php echo $num_commande; ?>"><button style="margin-top:30px;" class="btn btn-success btn-lg btn-block" type="button" >oui</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
