...
try{
                    ...
                    <td>
                        <table style="width:100%;  cellspacing:0; cellpadding:0;margin-top:100px;margin-bottom:30px;">
                            <tr>
                                ...
                                Date alerte : '.$date_convertie.'<br/></td>
    ...
    <table style="width:100%;margin-left:20px;"  cellspacing:0; cellpadding:0">
        <tr style="border-style:solid;border-width:1px;border-color:blue;background-color:#7389CE;">
            <th style="width:30%;margin-right:0px;">Produits</th>
    ...
    for($i=0;$i<$taille;$i++){
        ...
        $adresse_qte = 'qte'.$i;
        $adresse_vente = 'prix_vente'.$i;


        $_GET[$adresse_produit];
        $content.='<tr>
            <td  style="height:30px;width:30%;border-style:solid;border-width:1px;border-color:blue;background-color:#CBCED8">'.$_GET[$adresse_produit].'</td>
            <td  style="height:30px;width:30%;border-style:solid;border-width:1px;border-color:blue;">'.$_GET[$adresse_qte].'</td>
            <td  style="height:30px;width:30%;border-style:solid;border-width:1px;border-color:blue;background-color:#CBCED8">'.$_GET[$adresse_vente].'</td>
    ...
    <td  style="height:30px;width:30%;border-style:solid;border-width:1px;border-color:blue;background-color:#CBCED8"></td>
    <td  style="height:30px;width:30%;border-style:solid;border-width:1px;border-color:blue;"></td>
    <td  style="height:30px;width:30%;border-style:solid;border-width:1px;border-color:blue;background-color:#CBCED8"></td>
...
<tr >
<td style="height:50px;width:50%;border-style:solid;border-width:1px;border-color:black;" >
...
':num_commande' =>$num_commande,));    */
    ...
    $html2pdf->Output(__DIR__ .' /upload/'.$num_commande.'.pdf', 'F');
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="vente_2.php">Vente</a>
