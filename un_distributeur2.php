...
<!--<form action="trt_caisse.php" method="POST">-->
    <center>
        <h1 class="h3 mb-4 text-gray-800">Le distributeur sélectionné est <?= $_GET['nom'] ?> <br/> <?php //echo $req['categorie']." ";
                                                                         //echo $req['volume']." ";
                                                                         //echo $req['parfum'];?></h1>
    </center>
    <div class="row">
                        ...
                        <div class="col mr-2">
                            ...
                            <div class="h6 mb-0 font-weight-bold text-gray-800 message row" id="message">
                                <div class="col-lg-4" style="margin-bottom:10px;">
                                    <a href="ses_BC.php?nom=<?= $_GET['nom'] ?>" style="text-decoration:none;"><button  class="btn btn-success btn-lg ">Ses BC</button></a>
                                </div>
                                <div class="col-lg-4" style="margin-bottom:10px;">

                                    <a href="ses_BL.php?nom=<?= $_GET['nom'] ?>" style="text-decoration:none;"><button  class="btn btn-success btn-lg ">Ses BL</button></a>
                                </div>
                                <div class="col-lg-4">
                                    <a href="ses_factures.php?nom=<?= $_GET['nom'] ?>"><button  class="btn btn-success btn-lg ">Ses factures</button></a>
                                </div>
