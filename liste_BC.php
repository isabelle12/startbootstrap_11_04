                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h6 mb-0 font-weight-bold text-gray-800 message" id="message">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <form class="navbar-search" action="trt_BC.php">
                                            ...
                                            <input type="text" class="form-control" placeholder="Rechercher" autocomplete="off" aria-label="Search" aria-describedby="basic-addon2" value="" id="search-stock7" name="nom_distributeur">
                                ...
                                <button type="button" id="bouton_distributeur6" class="btn btn-success btn-lg btn-block">Valider</button>
                                <br />
