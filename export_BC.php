...
try{
    ...
    <tr style="margin-top:100px;">
        ...
        <td><img width="200" src="'.$_GET['file'].'" /></td>
    </tr>
</table>
</td>
</tr>
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800 message" id="message">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 offset-lg-3">
                                        <br /><br />
                                        <div id="sig"></div>
                                        Voulez vous créer aussi un bon de livraison?
                                        <?php
                                        $chaine="";
                                        $chaine2="";
                                        ...
                                        ?>
                                        <a style="text-decoration:none;" href="export_BC_2.php?details=<?php echo $_GET['details'] ?>&nom=<?php echo $_GET['nom'] ?>&adresse=<?php echo $_GET['adresse'] ?>&mail=<?php echo $_GET['mail'] ?>&telephone=<?php echo $_GET['telephone'] ?>&num_facture=<?php echo $_GET['num_facture'] ?>&num_commande=<?php echo $_GET['num_commande'].$chaine; ?> &taille=<?php echo $taille; ?>&file=<?php echo $file; ?>&alerte=<?php echo $alerte; ?>"><button class="btn btn-success btn-lg btn-block" type="button">créer pdf bon de livraison</button></a>
