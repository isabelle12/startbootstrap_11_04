<?php
include('bdd.php');
$req_volume = $bdd->prepare("SELECT * FROM categorie_volume INNER JOIN volumes ON categorie_volume.id_volume = volumes.id WHERE categorie_volume.id_categorie = '" . $_GET['id'] . "'");
$req_volume->execute(array());
$req_volume = $req_volume->fetchAll();
$req_parfum = $bdd->prepare("SELECT * FROM parfum_categorie INNER JOIN parfums ON parfum_categorie.id_parfum = parfums.id WHERE parfum_categorie.id_categorie_parfum = '" . $_GET['id'] . "'");
$req_parfum->execute(array());
$req_parfum = $req_parfum->fetchAll();
/*$req = $bdd->prepare("SELECT * FROM categories WHERE id='" . $_GET['id'] . "'");
$req->execute(array());
$req = $req->fetch();*/
?>
<!DOCTYPE html>
            ...
            <div id="content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 col-lg-9">
                        ...
                        <a href="index3.php"><button style="margin-left:30px;margin-bottom:30px;color:black;" type="submit" class="btn mauve btn-lg ">Retour à l'accueil de l'inventaire</button></a>
                        <a href="choix_categories.php" style="color:black;"><button style="margin-left:30px;margin-bottom:30px;color:black;" type="submit" class="btn mauve btn-lg ">Retour au choix de la catégorie</button></a>
                    </div>
                </div>
            ...
            if (!empty($_POST['parfum']) and $_POST['parfum'] != "") {
                if (isset($_POST['quantite'])) {
                    if (!empty($_POST['quantite']) and $_POST['quantite'] != "") {
                        ...
                        $req_insertion = $bdd->prepare('INSERT INTO articles(categorie,volume,parfum,quantite) VALUES(:categorie,:volume,:parfum,:quantite)');
                        $req_insertion->execute(array(':categorie' =>$req['nom'],
                                                      ':volume' =>$_POST['volume'],
                                                      ':parfum' =>$_POST['parfum'],
