            ...
            <div id="content">
                ...
                <table id="lastMateriel" class="table table-bordered " style="background-color:white;">
                    <tbody>
                        <tr>
                            <td>
                                <select class="form-control categorie" name="parfum" required>
                            ...
                            <td>
                                <select class="form-control volume" id="select_volume" name="parfum" required>>
                            ...
                            <td>
                                <select class="form-control" name="parfum" id="select_parfum" required>>
                            ...
                            <td>
                                <select class="form-control clients" id="clients" name="parfum" required>>
                                    ...
                                    ?>
                                        <option id="qte_de_base" value="<?php echo $result['id']; ?>"><?php echo $result['nom'];  ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
