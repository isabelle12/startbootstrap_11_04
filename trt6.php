...
<a style="text-decoration:none;margin-top:30px;" href="export_facture4.php?details=<?php echo $_GET['details'] ?>&nom=<?php echo $_GET['nom'] ?>&enseigne=<?php echo $_GET['enseigne'] ?>&adresse=<?php echo $_GET['adresse'] ?>&mail=<?php echo $_GET['mail'] ?>&telephone=<?php echo $_GET['telephone'] ?>&num_facture=<?php echo $_GET['num_facture'] ?>&num_commande=<?php echo $_GET['num_commande'].$chaine; ?> &taille=<?php echo $taille; ?>&file=<?php echo $file; ?>&alerte=<?php echo $alerte; ?>"><button class="btn btn-success btn-lg btn-block" type="button">créer PDF facture</button></a>
<?php } ?>
            </div>
        </form>
