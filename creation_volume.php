        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid" style="max-width:700px;margin-bottom:30px;height:200px;">
                    <center>
                        <h3 class="h3 mb-4 text-gray-800">Création d'un volume / d'un poids</h3>
                    </center>
...
echo $_POST['quantite'];*/
if (isset($_POST['nom'])) {
    if (!empty($_POST['nom']) and $_POST['nom'] != "") {        
        $req_insertion = $bdd->prepare('INSERT INTO volumes(quantite) VALUES(:nom)');
        $req_insertion->execute(array(':nom' =>$_POST['nom'],                                                      
                                    ));   
    ?>
<script type='text/javascript'>
window.location.href = "creation_volume.php"
</script>
<?php
    }
}
