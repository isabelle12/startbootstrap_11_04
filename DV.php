...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="DV.html">Dépôt vente</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
            <center>
    <h1 class="h3 mb-2 text-gray-800">Liste des dépôts-vente</h1>
</center>
<br />
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
   <!--<a href="a_aller_voir.php" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm">    <i class="fa fa-bell"></i>
</i> Clients a aller voir aujourd'hui</a>-->
<a href="creation_BC_BL.php" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm">    <i class="fa fa-bell"></i>
</i> Création BL et BC</a>
        <table id="lastMateriel" class="table table-bordered " style="background-color:white;">
            ...
            <tbody>
                ...
                while ($listresult = $req_fav->fetch()) {
                    //echo date('Y-m-d');// 2012-10-11 15:35:53

                    $date = $listresult['date_depot'];
                    echo $date;
                    $tableau_date = explode(" ",$date);
                    //var_dump($tableau_date);
                    //echo $tableau_date[0];
                    $jours = $tableau_date[0];
                    echo "<br/>";
                    //echo strtotime($tableau_date[0]);
                    ...
                    echo $date_convertie;
                    echo "<br/>";
                    $req_maj = $bdd->query("UPDATE `distributeurs` SET date_alerte =  '" . $date_convertie . "'");
                ...
                ?>
                        ...
                        <td><a href=""><?php echo $listresult['date']; ?></a></td>
