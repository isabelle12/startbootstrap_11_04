...
<script>
    $("#bouton").on('click',function(){
        $("#message").html("<h5>Votre document va être créé, ces éléments y apparaîtront :<br/>"+"<br/>")
        $("#message").append("<select class='bouton'><option value='un'>un</option><option value='deux' >deux</option></select>")
        $("select.bouton").change(function(){
        console.log("kikou")
    });
    });
