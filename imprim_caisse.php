...
$content = '<page>
        <div style="width:600px;max-width:600px;">
            <table style="width:100%">
                ...
                <tr >
                    <td>
                        <table style="width:100%;  cellspacing:0; cellpadding:0;margin-top:100px;margin-bottom:70px;">
                            <tr>
                                <td style=" width:40%">
...
$content.='<br/>
                                ...
                                <td  style="width:30%">'.$_GET['nom'].'<br/>'.$_GET['adresse'].
                                '</td>
                ...
                <tr>
                    <td>
                        <table style="margin-top;100px;width:97%;margin-left:15px;cellspacing:0; cellpadding:0;border-spacing: 0; border-width: 0; padding: 0; border-width: 0;  border-collapse: collapse;">
                            <tr padding-top:60px;style="border-style:solid;border-width:1px;border-color:#DCDAD9;background-color:#E5E5E5;height:40px;">
                                ...
                                for($i=0;$i<$_GET['taille'];$i++){
                                  ...
                                  $index3 = "prix_DV".$i; 
                                  $index4 = "prix_vente".$i; 
                                  $produit_operation = (int)$_GET[$index4]*(int)$_GET[$index2];
                        ...
                        <th></th>
                            ...
                            <tr >
                                ...
                                <td style="padding-top:20px;height:30px;width:22%;background-color:#E5E5E5;padding-left:10px;" >Total HT
                                <span style="margin-left:40px"id="un">'.$somme.'€</span> ';    
                                $TVA = $somme*0.2;
                                $somme=$TVA+$somme;
                                $content.='
                                <br/>TVA<span id="trois" style="margin-left:70px;">'.$TVA.'€</span><br/><br/>

                                <span id="deux" style="font-weight:bold;">Total TTC </span><span style="margin-left:30px;font-weight:bold;">'.$somme.'€</span> 
                                </td>
                            </tr>
                        </table>
