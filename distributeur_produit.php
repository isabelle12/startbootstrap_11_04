...
<form action="" method="POST">
    <center>
        <h1 class="h3 mb-4 text-gray-800">Associer un produit avec un distributeur : <br/> <?php //echo $req['categorie']." ";
                                                                         //echo $req['volume']." ";
                                                                         //echo $req['parfum'];?></h1>
    </center>
    <div class="row">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h6 mb-0 font-weight-bold text-gray-800">
                                ...
                                <br />
                                <br />
                                <select class="form-control" name="distributeur" required>
                                ...
                                <?php 
                                    ...
                                    if(isset($_POST['quantite']) AND isset($_POST['distributeur']) AND isset($_POST['produit'])){
                                        echo "qte";
                                        echo $_POST['quantite'];
                                        echo "distributeur";
                                        ...
                                        $req_insertion = $bdd->prepare("INSERT INTO distributeur_produit(id_distributeur,id_produit,quantite,date_de_depot,date_alerte) VALUES(:distributeur,:produit,:quantite,:date_de_depot,:date_alerte)");
                                        $req_insertion->execute(array(':distributeur' =>$_POST['distributeur'],
                                                                        ':produit' =>$_POST['produit'],
                                                                        ':quantite' =>$_POST['quantite'],
                                                                        ':date_de_depot' =>$_POST['date'],
                                    ...
                                    ?>   
                                        ...
                                        window.location.href = "distributeur_produit.php"
                                        //modif.php?id=<?php //echo $_GET['id']; ?>
                                        </script>
                                        <?php
                                    }
