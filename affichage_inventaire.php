                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <table id="lastMateriel" class="table table-bordered " style="background-color:white;">
                                ...
                                <tbody>
                                    <?php
                                    $req = $bdd->prepare("SELECT categories.nom, categories.id AS id_categorie,articles.categorie,articles.volume,articles.parfum,articles.quantite,articles.id FROM articles INNER JOIN categories ON articles.categorie = categories.nom ");
                                    $req->execute(array());
                                    while ($listresult = $req->fetch()) {
                                        if ($listresult['categorie'] != NULL) {
                                    ?><div class="row">
                                            <div class="col-lg-3 col-md-3 col-sm-3">
                                                <p style="font-size : 20px;"><?php echo $listresult['categorie']; ?></p>
                                                 </div>
                                                 <div class="col-lg-2 col-md-2">
                                                <p style="font-size : 20px;"><?php echo $listresult['volume']; ?></p>
                                                </div>
                                                <div class="col-lg-3 col-md-3">
                                                <p style="font-size : 20px;"><?php echo $listresult['parfum']; ?></p>
                                                </div>
                                                <div class="col-lg-2 col-md-1">
                                                <p style="font-size : 20px;"><?php echo $listresult['quantite']; ?></p>
                                                </div>
                                                <div class="col-sm-12 col-xs-12 col-lg-1 col-md-1">
                                                <img src="img/deodorant.png" />
                                                </div>
                                                <div class="col-sm-12 col-xs-12 col-lg-1">

                                                <a href="modif.php?id_categorie=<?php echo $listresult['id_categorie'];?>&id=<?php echo $listresult['id'];?> "><button class="btn btn-success">modifier</button></a>                                             
                                                </div>
