...
<div class="row">
        ...
        <div class="row" id="bordure" style="margin-left:20px;color:black;height:800px;border: 1px solid #E5E5E5;padding-top:20px;">
            <div class="col-lg-12">
                ...
                <div class="row" style="padding-right:20px;"  >
                    <div class="col-lg-3 offset-lg-9" style="background-color:#E5E5E5;width:px;height:60px;margin-top:350px;margin-right:10px;">
                        <div class="row">
                            <span  style="margin-right:5px;font-size:12px;">Total HT</span>
    ...
    <div class="col-lg-5">
        ...
        <button style="margin-bottom:20px;" id="inserer7" type="button" class="btn btn-success btn-lg ">Ajouter un produit</button>
    ...
    <div class="row" style="margin-top:20px;">
            <a id="signer" style="margin-bottom:30px;text-decoration:none;margin-top:px;margin-left:30px;width:;margin-right:20px;" href="imprim_caisse.php?details=<?php //echo $_GET['details'] ?>&nom=<?php //echo $_GET['nom'] ?>&paye=paye&adresse=<?php //echo $_GET['adresse'] ?>&mail=<?php //echo $_GET['mail'] ?>&telephone=<?php //echo $_GET['telephone'] ?>&num_facture=<?php //echo $_GET['num_facture'] ?>&enseigne=<?php //echo $_GET['enseigne'] ?>&num_commande=<?php //echo $_GET['commande']//.$chaine; ?> &file=<?php //echo $file; ?>&alerte=<?php //echo $date_alerte; ?>&date_commande=<?php //echo $date_commande;?>"><button class="btn btn-success btn-lg " type="button">Créer PDF facture payée</button></a><br/>
            <a id="signer_NP" style="text-decoration:none;margin-top:px;margin-left:30px;width:;margin-right:20px;" href="imprim_caisse.php?details=<?php //echo $_GET['details'] ?>&nom=<?php //echo $_GET['nom'] ?>&adresse=<?php //echo $_GET['adresse'] ?>&paye=nonpaye&mail=<?php //echo $_GET['mail'] ?>&telephone=<?php //echo $_GET['telephone'] ?>&num_facture=<?php //echo $_GET['num_facture'] ?>&enseigne=<?php //echo $_GET['enseigne'] ?>&num_commande=<?php //echo $_GET['commande']//.$chaine; ?> &file=<?php //echo $file; ?>&alerte=<?php //echo $date_alerte; ?>&date_commande=<?php //echo $date_commande;?>"><button class="btn btn-success btn-lg " type="button">Créer PDF facture non payée</button></a><br/>
