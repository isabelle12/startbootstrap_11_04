        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container">
                        ...
                        <div class="row" id="categories" style="margin-bottom:30px;" >
                            ...
                            <?php
                                ...
                                ?>
                                    <img src="img/deodorant.png" style="margin-bottom:30px;" /><a href="creation_article.php?id=<?php echo $result['id'] ?>"><button style="margin-bottom:30px;margin-right:30px;" type="submit" class="btn btn-success btn-lg "><?php echo $result['nom']; ?></button></a>
                                <?php
                                }
                                ?>
                        </div>
