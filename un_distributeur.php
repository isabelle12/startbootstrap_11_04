...
<!--<form action="trt_caisse.php" method="POST">-->
    <center>
        <h1 class="h1 mb-4 text-gray-800"> <br/> Informations sur l'entreprise</h1>
    </center>
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class=" row mb-1  text-gray-800 message" id="message"><!--<center>-->
                                <div class="col-lg-6">
                                    <p style="font-size:30px;font-weight:bold;">Nom : </p>
                                    <p style="font-size:30px;font-weight:bold;">Enseigne : </p>
                                    <p style="font-size:30px;font-weight:bold;">Siret : </p>
                                    <p style="font-size:30px;font-weight:bold;">Adresse : </p>
                                    <p style="font-size:30px;font-weight:bold;">Téléphone :  </p>
                                </div>
                                <div class="col-lg-6">
                                    <p style="font-size:30px;"><?php echo $_GET['nom']."<br/>"; ?></p>
                                    <p style="font-size:30px;"><?php echo $_GET['enseigne']."<br/>";?></p>
                                    <p style="font-size:30px;"><?php echo $_GET['siret']."<br/>";?></p>
                                    <p style="font-size:30px;"><?php echo $_GET['adresse'];?></p>
                                    <p style="font-size:30px;"><?php echo $_GET['telephone'];?></p>
                                </div>
                            </div><!--</center>-->
