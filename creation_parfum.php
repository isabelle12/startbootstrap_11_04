        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid" style="max-width:700px;margin-bottom:30px;height:200px;">
                    <center>
                        <h3 class="h3 mb-4 text-gray-800">Création d'une fragrance</h3>
                    </center>
...
if (isset($_POST['nom'])) {
    if (!empty($_POST['nom']) and $_POST['nom'] != "") {        
        $req_insertion = $bdd->prepare('INSERT INTO parfums(nom_parfum) VALUES(:nom)');
        $req_insertion->execute(array(':nom' =>$_POST['nom'],                                                      
                                    ));   
    ?>
<script type='text/javascript'>
window.location.href = "creation_parfum.php"
</script>
<?php
    }
}
