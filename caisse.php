...
<!--<form action="trt_caisse.php" method="POST">-->
    <center>
        <h1 class="h3 mb-4 text-gray-800">Création d'une facture : <br/> <?php //echo $req['categorie']." ";
                                                                         //echo $req['volume']." ";
                                                                         //echo $req['parfum'];?></h1>
    </center>
    <div class="row">
                            ...
                            <div class="h6 mb-0 font-weight-bold text-gray-800 message" id="message">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <textarea type="text" placeholder="Adresse" id="adresse" name="adresse" class="form-control"></textarea>
                                        <br />

                                        <input type="text" placeholder="Téléphone" id="telephone" name="telephone" class="form-control"/>
                                        <br />

                                        <input type="text" placeholder="Email" class="form-control" id="mail" name="mail"/>
                                ...
                                <select name="paiement" class="form-control paiement"> 
                                    <option value="Paypal">Paypal</option>
                                    <option value="Chèque">Chèque</option>
                                    <option value="Espèces">Espèces</option>
                                    <option value="Paypal">Carte bleue</option>
                                ...
                                <button type="submit" id="bouton_caisse" class="btn btn-success btn-lg btn-block">Valider</button>
                                <br />
