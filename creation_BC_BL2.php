...
<!--<form action="trt_caisse.php" method="POST">-->
    <center>
        <h1 class="h3 mb-4 text-gray-800">Création d'un BC+BL ou d'une facture : <br/> <?php //echo $req['categorie']." ";
                                                                         //echo $req['volume']." ";
                                                                         //echo $req['parfum'];?></h1>
    </center>
    <div class="row">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h6 mb-0 font-weight-bold text-gray-800 message" id="message">
                                <a href="creation_BC_BL3.php" style="text-decoration:none;"> <button class="btn btn-success btn-lg btn-block">Créer BC et BL</button></a>
                                <br/><br/>

                                <a href="creation_BC_BL4.php" style="text-decoration:none;"><button class="btn btn-success btn-lg btn-block">Créer facture</button></a>
                                </div>
