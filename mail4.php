...
try {
    ...
    $mail->addAttachment('upload/'.$num_commande.'_BL.pdf');         // Pièces jointes en gardant le nom du serveur


    //Content
    $mail->isHTML(true);                                  //Set email format to HTML
    $mail->Subject = 'Bon de commande signé numéro '.$num_commande;
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800 message" id="message">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg- offset-lg-1">
                                        <br /><br />
                                        <div id="sig"></div>
                                        Votre bon de commande et votre bon de livraison au format PDF ont bien été envoyés par mail au client    
                                    </div>
                                </div>
                            </div>
                        </div>
