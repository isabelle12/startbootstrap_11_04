                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <form class="navbar-search" action="trt_BC.php">
                                            ...
                                            <input type="text" class="form-control" placeholder="Rechercher" autocomplete="off" aria-label="Search" aria-describedby="basic-addon2" value="" id="search-stock13" name="nom_distributeur">
                            ...
                            <?php 
                            if($_GET['prix']=="DV"){?>
                                <a style="text-decoration:none;" href="voir_BC2.php?num_commande=<?php echo $chaine3; ?>&alerte=<?php echo $date_convertie; ?>&prix=DV&nom=<?php if(isset($_GET['nom'])){echo $_GET['nom'];} ?>&enseigne=<?php if(isset($_GET['enseigne'])){echo $_GET['enseigne'];} ?>&adresse=<?php if(isset($_GET['adresse'])){echo $_GET['adresse'];} ?>&telephone=<?php if(isset($_GET['telephone'])){echo $_GET['telephone'];}?>&mail=<?php if(isset($_GET['mail'])){echo $_GET['mail'];} ?>&details=<?php if(isset($_GET['details'])){echo $_GET['details'];} ?>"><button type="button" id="" class="btn btn-success btn-lg btn-block">Valider</button></a>
                            <?php } 
                            if($_GET['prix']=="vente"){?>
                                <a style="text-decoration:none;" href="voir_BC2.php?num_commande=<?php echo $chaine3; ?>&alerte=<?php echo $date_convertie; ?>&prix=vente&nom=<?php if(isset($_GET['nom'])){echo $_GET['nom'];} ?>&enseigne=<?php if(isset($_GET['enseigne'])){echo $_GET['enseigne'];} ?>&adresse=<?php if(isset($_GET['adresse'])){echo $_GET['adresse'];} ?>&telephone=<?php if(isset($_GET['telephone'])){echo $_GET['telephone'];}?>&mail=<?php if(isset($_GET['mail'])){echo $_GET['mail'];} ?>&details=<?php if(isset($_GET['details'])){echo $_GET['details'];} ?>"><button type="button" id="" class="btn btn-success btn-lg btn-block">Valider</button></a>
                            <?php } ?>
                                <br />
