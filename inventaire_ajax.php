            ...
            <div id="content">
                ...
                <div class="container-fluid" style="max-width:700px;margin-bottom:30px;height:400px;">
                    ...
                    <form action="" method="POST">
                        <center>
                            <h1 class="h3 mb-4 text-gray-800">Création d'un article</h1>
                        </center>
                        <div class="row">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h6 mb-0 font-weight-bold text-gray-800">
                                                    ...
                                                    <select class="form-control" id="select_categorie" placeholder="AEMA" name="categorie">
                                                    ...
                                                    if(!empty($_POST['categorie'])) {
                                                        ...
                                                        $req_nom = $bdd->prepare("SELECT * FROM categories WHERE id ='" . $categorie . "'");
                                                        $req_nom->execute(array());
                                                        $req_nom = $req_nom->fetch();
                                                        ?>
                                                        <p style="margin-top:1rem;"><?php
                                                        echo "Vous avez choisi la catégorie ".$req_nom['nom'];  
                                                        ?>
                                                        </p>
                                                        <?php                                                 
                                                    ...
                                                    ?> 
                                                    <!--<input type="hidden" id="valeur" value = <?php echo $req; ?> />      -->
                                                    <br />
                                                    ...
                                                    //echo $_POST['categorie']; 
                                                        ...
                                                        <button type="submit" class="btn btn-success btn-lg btn-block">Je choisis cette catégorie</button>
                                                        <?php
                                                    }
                                                        ?>
